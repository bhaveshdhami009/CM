...
// --- Case Routes ---
router.get('/', authenticateToken, hasPermission(ROLES.VIEWER), caseController.getAll);
router.post('/', authenticateToken, hasPermission(ROLES.EDITOR), validateDto(CreateCaseDto), // <--- Use DTO Validation
caseController.create);
router.get('/:id', authenticateToken, hasPermission(ROLES.VIEWER), caseController.getOne);
// --- Sub-Routers ---
...
// --- Edit / Delete Routes ---
router.put('/:id', authenticateToken, hasPermission(ROLES.EDITOR), validateDto(CreateCaseDto), // <--- Use DTO Validation
caseController.update);
router.delete('/:id', authenticateToken, hasPermission(ROLES.ORG_ADMIN), caseController.delete);
