...
// Create New Setting
router.post('/', hasPermission(ROLES.PLATFORM_ADMIN), validateDto(CreateSettingDto), controller.create);
// Update/Version Setting (using key in URL)
router.post('/:key', hasPermission(ROLES.PLATFORM_ADMIN), validateDto(CreateSettingDto), controller.update);
