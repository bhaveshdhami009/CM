...
export class AuthService {
    constructor() {
        ...
        this.authLogRepo = AppDataSource.getRepository(AuthLog);
    ...
    // 2. Optimized Login
    async login(data, ip, userAgent, rememberMe) {
    ...
    // 5. Change Password
    async changePassword(userId, oldPass, newPass, revokeAllSessions) {
